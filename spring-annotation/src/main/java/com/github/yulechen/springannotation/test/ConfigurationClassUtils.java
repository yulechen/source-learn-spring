...
abstract class ConfigurationClassUtils {
    ...
    private static final String ORDER_ATTRIBUTE = Conventions.getQualifiedAttributeName(
        ConfigurationClassPostProcessor.class, "order");
    ...
    public static boolean isLiteConfigurationCandidate(AnnotationMetadata metadata) {
        ...
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("Failed to introspect @Bean methods on class [" + metadata.getClassName()
                        + "]: " + ex);
            }
            return false;
        }
